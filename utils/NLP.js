...
const Respuesta = require('../models/ChatBot_models/models_respuestas');
const Tema = require('../models/ChatBot_models/models_temas');
const { PalabrasClave, PalabrasPorSubtema } = require('./palabras_tema');
...
/**
 * Calcula un score de similitud entre dos cadenas.
